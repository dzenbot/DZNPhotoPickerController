...
+ (void)setConsumerKey:(NSString *)consumerKey consumerSecret:(NSString *)consumerSecret service:(DZNPhotoPickerControllerService)service
{
    ...
    NSAssert((service == DZNPhotoPickerControllerService500px || service == DZNPhotoPickerControllerServiceFlickr || service == DZNPhotoPickerControllerServiceGoogleImages), @"Only 500px and Flickr are supported at this moment.");
