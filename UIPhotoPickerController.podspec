...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dzenbot/UIPhotoPickerController.git", :tag => "v1.0.1" }
  s.source_files  = 'Classes', 'Source/**/*.{h,m}'
  s.requires_arc = true
  s.framework  = 'MobileCoreServices'
  s.dependency 'AFNetworking', '~> 1.3.3', :inhibit_warnings => true
  s.dependency '500px-iOS-api', '~> 1.0.4', :inhibit_warnings => true
  s.dependency 'FlickrKit', '~> 1.0.2', :inhibit_warnings => true
  s.dependency 'SDWebImage', '~> 3.4', :inhibit_warnings => true
end